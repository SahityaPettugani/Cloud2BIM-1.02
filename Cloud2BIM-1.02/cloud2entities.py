...
def parse_arguments():
    ...
    parser.add_argument("--pc_resolution", type=float, default=0.01, help="Minimum point distance after dilution (m)")
    parser.add_argument("--grid_coefficient", type=int, default=3, help="Computational grid size [px/mm]")
    ...
    # Wall parameters
    parser.add_argument("--min_wall_length", type=float, default=0.2, help="Minimum wall length (m)")
    parser.add_argument("--min_wall_thickness", type=float, default=0.08, help="Minimum wall thickness (m)")
    parser.add_argument("--max_wall_thickness", type=float, default=0.5, help="Maximum wall thickness (m)")
    parser.add_argument("--exterior_walls_thickness", type=float, default=0.25, help="Exterior wall thickness (m)")
    parser.add_argument("--wall_density_threshold", type=float, default=0.001,
                        help="2D histogram density threshold for wall detection")
    parser.add_argument("--wall_z_low", type=float, default=0.2,
                        help="Lower bound of storey height used for wall detection (0-1)")
    parser.add_argument("--wall_z_high", type=float, default=0.95,
                        help="Upper bound of storey height used for wall detection (0-1)")
...
wall_density_threshold = args.wall_density_threshold
wall_z_low = args.wall_z_low
wall_z_high = args.wall_z_high
    ...
    (start_points, end_points, wall_thicknesses, wall_materials,
     translated_filtered_rotated_wall_groups, wall_labels) = (
        identify_walls(storey_pointcloud, pc_resolution, min_wall_length, min_wall_thickness, max_wall_thickness,
                   ...
                   wall_density_threshold=wall_density_threshold,
                   wall_z_section_boundaries=(wall_z_low, wall_z_high)))
